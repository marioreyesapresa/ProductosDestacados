...
export default function CreateProductScreen ({ navigation, route }) {
  ...
  // solucion
  const initialProductValues = { name: null, description: null, price: null, order: null, restaurantId: route.params.id, productCategoryId: null, availability: true, promoted: false, highlight: false }
