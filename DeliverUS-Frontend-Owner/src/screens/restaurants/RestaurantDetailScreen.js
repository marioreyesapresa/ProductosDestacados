...
export default function RestaurantDetailScreen ({ navigation, route }) {
  ...
  const highlightProduct = async (product) => {
    try {
      ...
      showMessage({
        message: `Product ${product.name} succesfully highlightes`,
        type: 'success',
        style: GlobalStyles.flashStyle,
        titleStyle: GlobalStyles.flashTextStyle
      })
  ...
  return (
    <View style={styles.container}>
      ...
      <ConfirmationModal
        ...
        onConfirm={() => promoteProduct(productToBePromote)}>
          <TextRegular>the product will be promote.</TextRegular>
      </ConfirmationModal>
      <ConfirmationModal
        ...
        onConfirm={() => highlightProduct(productToBeHighlighted)}>
          <TextRegular>the product will be highlight.</TextRegular>
      </ConfirmationModal>
    </View>
  )
}
